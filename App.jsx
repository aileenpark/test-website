...
function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const onOver = (e) => {
      if (e.target.closest('a, button, [role="button"]')) hovering = true;
    };
    const onOut = (e) => {
      if (e.target.closest('a, button, [role="button"]')) hovering = false;
    };
    ...
    const loop = () => {
      ...
      cursor.style.transform = `translate(${curX - curSize / 2}px, ${curY - curSize / 2}px)`;
